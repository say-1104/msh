...
rm _results.dat
#for wavelength in `seq 1.270 0.02 1.330`
...
do
    ...
    sed -i -e "9i $nsi  0.00000000" wire.v2.msh
    sed -i -e "10d" wire.v2.msh
    sed -i -e "10i $ncpcm  0.00000000" wire.v2.msh

    /home/okazaki/Solver/2D_VFEM/edge `ls *v2.msh | sed -e "s/\.msh//g"` -w $wavelength -d 1.0 -F 70
