...
dz=0.1
echo -n > heatmap100_g200_wr400_500.dat
echo -n > heatmap0_g200_wr400_500.dat
for L in `seq 20 0.1 180`
do
    for g in `seq 0.400 0.001 0.500`
    do
        echo "L: ${L}\tdw: ${g}"
        echo -n > forMD.dat
        ...
        echo "${L}\t${g}\t`head -n1 MDlambda`" >> heatmap100_g200_wr400_500.dat
        ...
        ./calc_MD0 <forMD.dat
        echo "${L}\t${g}\t`head -n1 MDlambda`" >> heatmap0_g200_wr400_500.dat
    done
