...
dz=0.1
echo -n > heatmap100_wr400_g200_300.dat
echo -n > heatmap0_wr400_g200_300.dat
...
do
    ...
    do
        ...
        echo "${L}\t${g}\t`head -n1 MDlambda`" >> heatmap100_wr400_g200_300.dat
        ...
        ./calc_MD0 <forMD.dat
        echo "${L}\t${g}\t`head -n1 MDlambda`" >> heatmap0_wr400_g200_300.dat
    done
